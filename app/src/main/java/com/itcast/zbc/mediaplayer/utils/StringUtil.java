...
public class StringUtil {
	...
	public static String transformBIG(String url) {
		return url.substring(0, url.lastIndexOf(".")) + ".big" + url.substring(url.lastIndexOf("."), url.length());
	}
	...
	public static SpannableString formatText(int left, int right) {
		...
		ssb.setSpan(new AbsoluteSizeSpan(40, true), 0, index, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
		ssb.setSpan(new ForegroundColorSpan(Color.parseColor("#ff7800")), 0, index, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
		ssb.setSpan(new AbsoluteSizeSpan(18, true), index, num.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
		ssb.setSpan(new ForegroundColorSpan(Color.parseColor("#fefefe")), index, num.length(),
