package com.itcast.zbc.mediaplayer.utils.jsonParserUtils;
...
import com.itcast.zbc.mediaplayer.utils.StringUtil;
...
public class JsonUtils {
     ...
     * @return 泛型集合
     */
    public static <T> List<T> getBeanList(String json, String key,
                                          Class<T> beanClass) {
     ...
     * @return
     */
    public static Object getObjectByKey(String json, String key, int type) {
        JsonParser parser = new JsonParser();
     ...
     * @return
     */
    public static Object getObjectByKey(String json, String key, String targetkey, int type) {
        JsonParser parser = new JsonParser();
        JsonElement jsonElement;
        try {
            JsonObject jsonObject = parser.parse(json).getAsJsonObject();
            ...
            switch (type) {
                case 0:
                    return jsonElement.getAsJsonObject().get(targetkey).getAsString();
                case 1:
                    return jsonElement.getAsJsonObject().get(targetkey).getAsJsonObject();
                case 2:
                    return jsonElement.getAsJsonObject().get(targetkey).getAsJsonArray();
