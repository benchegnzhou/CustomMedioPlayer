...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //自定义的方法
        getMeasureSpec(widthMeasureSpec, heightMeasureSpec, width, height);
...
//      return;
    ...
    public void switchFullScreen() {
        if (isFullSreen) {
            ...
            Log.e("VideoView.switchFullScreen,mDefaultW=" + mDefaultW + ";mDefaultH=" + mDefaultH + ";isFullSreen=" + isFullSreen);
            Log.e("VideoView.switchFullScreen,mScreenW=" + mScreenW + ";mScreenH=" + mScreenH + ";isFullSreen=" + isFullSreen);
        } else {
    ...
    /**
     * 自定义的方法获VideoView摆放后的宽高
     * @param widthMeasureSpec
     * @param heightMeasureSpec
     * @param width
     * @param height
     */
    private void getMeasureSpec(int widthMeasureSpec, int heightMeasureSpec, int width, int height) {
        if (mVideoWidth > 0 && mVideoHeight > 0) {
